...
namespace AplikasiInputDataMahasiswa
{
    public partial class Form1 : Form
    {
        ...
        private void InisialisasiListView()
        {
            ...
            lvwMahasiswa.Columns.Add("Nama", 110, HorizontalAlignment.Center);
            lvwMahasiswa.Columns.Add("Kelas", 70, HorizontalAlignment.Center);
            lvwMahasiswa.Columns.Add("Nilai", 50, HorizontalAlignment.Center);
            lvwMahasiswa.Columns.Add("Nilai Huruf", 65, HorizontalAlignment.Center);
        ...
        private void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            //set nilai masing-masing propertinya
